  ...
  return (
    <>
      ...
      <div className='gold22-h' style={{ textAlign: "center" }}>
        <h1 style={{ fontSize: "25px", color: 'purple' }}>- OUR 22K GOLD COLLECTION -</h1>
        <p>
          Make a statement that reflects your legacy with our stunning 22k gold pieces. <br />
